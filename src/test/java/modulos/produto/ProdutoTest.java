...
public class ProdutoTest {
    ...
    @Test
    @DisplayName("Validar os limites proibidos do valor do Produto: 0.00")
    ...
    @Test
    @DisplayName("Validar os limites proibidos do valor do Produto: 7000,01")
    public void testValidarLimites7001ProibidoValorProduto() {
